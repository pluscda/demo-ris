        ...
        <b-container fluid class="px-1">
          <b-row no-gutters>
            <b-col sm="2" class="px-1">
              <ejs-textbox v-model="No" floatLabelType="Always" placeholder="藥品代碼" :showClearButton="true" @keyup.enter="onFilter" />
            </b-col>
            <!-- <b-col sm="2" class="px-1">
              <ejs-textbox v-model="EngName" floatLabelType="Always" placeholder="藥品名稱(英文)" :showClearButton="true" @keyup.enter="onFilter" />
            </b-col> -->
            <b-col sm="2" class="px-1">
              <ejs-textbox v-model="Name" floatLabelType="Always" placeholder="藥品名稱" :showClearButton="true" @keyup.enter="onFilter" />
            </b-col>
            <!-- <b-col sm="2" class="px-1">
              <ejs-dropdownlist
                v-model="Type"
