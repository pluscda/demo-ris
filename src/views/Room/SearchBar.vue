        ...
        <b-container fluid class="px-1">
          <b-row no-gutters>
            ...
            <b-col sm="2" class="px-1">
              <ejs-textbox v-model="Name" floatLabelType="Always" placeholder="檢查室名稱" :showClearButton="true" @keyup.enter="onFilter" />
            </b-col>
            <b-col sm="2" class="px-1">
              <ejs-textbox v-model="PhonNo" floatLabelType="Always" placeholder="檢查室電話" :showClearButton="true" @keyup.enter="onFilter" />
            </b-col>
            <b-col sm="2" class="px-1">
              <ejs-dropdownlist
                v-model="Department"
            ...
            <b-col sm="3" class="px-1" style="display: table; height: 60px;">
