  ...
  <div class="pageContent zhTW" style="min-height:829px;">
    <b-card no-body class="mx-1">
      <b-card-header class="bg-primary text-white cardHeader">
        <b-row no-gutters>
          <b-col cols="6" class="float-left text-left">藥品耗材登打作業</b-col>
        </b-row>
      </b-card-header>
    ...
    <!-- <b-modal ref="medicineModal" title="藥品耗材輸入" hide-footer size="xl">
      <b-row no-gutters class="mt-1">
        <b-col>
          <b-card no-body>
              ...
              <b-container fluid class="p-0">
                <b-row no-gutters>
                  <b-col>
                    <twp
                      ...
                      v-bind:onRowdbClick="MedicationContent"
                      v-bind:OpButton1Func="addCount"
                      OpButton1Text="+"
                      v-bind:OpButton2Func="cutCount"
                      OpButton2Text="-"
                ...
                <b-row no-gutters class="mt-1">
                  <b-col cols="6" class="float-left text-left ml-1">
                    <b-button variant="outline-primary" @click="AddMedication">
                      <font-awesome-icon icon="plus" />新增藥品
                    </b-button>
                  </b-col>
                </b-row>
              </b-container>
    ...
    >
      ...
      <b-container fluid id="editWindowForm">
        <b-row>
          <b-col>
            <b-input-group prepend="檢查項目">
              <b-input disabled class="text-primary" />
            </b-input-group>
          </b-col>
        </b-row>
        <b-row class="mt-1">
...
export default {
  ...
  methods: {
    ...
    async getFliterData(test, pageIndex, perpage) {
      ...
      let data = null;
      let status = "11,12,56,21,31,36,61,63,65,71,51,91";
      await new DataManager({
