<template>
  <section class="details" style="border-left:1px solid black;">
    ...
    <main class="my-3-grid my-body" v-for="(item, i) in inspectsArr" :key="item">
      <div>
        <img
          ...
          style="color:black;"
        />
        <span v-if="getResult(i + 7) == 3" style="color:black;">專</span>
        <span v-if="getResult(i + 7) == 4" style="color:black;">已</span>
        <span v-if="!getResult(i + 7)" style="color:black;">未</span>
      </div>
      <div>
        <img src="close.svg" width="12" height="12" v-if="getResult(i + 7) == 2" />
        <span v-if="getResult(i + 7) == 3" style="color:black;">檢</span>
        <span v-if="getResult(i + 7) == 4" style="color:black;">檢</span>
        <span v-if="!getResult(i + 7)" style="color:black;">檢</span>
      </div>
      <div
      ...
      <div
        ...
        :style="getSealStatus(i +7) > 1 ? 'border-bottom:1px solid black !important;': ''"
      >
