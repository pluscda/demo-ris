<template>
  <div class="pageLeftContent pb-1">
    <searchBar @filter="grdCheckCategory_filter" @filterClear="grdCheckCategory_filterClear"></searchBar>
    <b-container fluid class="mt-1 px-1">
      ...
      >
        <e-columns>
          ...
          <e-column field="No" headerText="檢查類別代碼" width="160" :validationRules="{ required: true }"></e-column>
          <e-column field="Name" headerText="檢查類別名稱" :validationRules="{ required: true }"></e-column>
          <e-column
            field="FixedDuration"
