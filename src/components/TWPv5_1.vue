    ...
    <b-row no-gutters class="mt-1">
      <b-col xl="12">
        ...
        >
          ...
          <template v-slot:cell(OpColumnType3)="row">
            <b-btn
              size="sm"
              variant="success"
              class="no-wrap mr-1"
    ...
    <b-row no-gutters class="mb-1" v-if="PagingEnabled">
      ...
      <b-col v-if="MultiSelectFunc && checkedItems.length > 0" sm="2" class="px-1 mt-1">
        <b-input-group>
          ...
          <b-input-group-append>
            <b-button variant="success" @click="OnMultiEdit">
...
export default {
  ...
  props: {
    ...
    heightForScroll: { type: Boolean, default: false },
    //是否要使用後端分業模式
